...
/**
 * @brief Returns a pointer pointing to the approximate top of the stack.
 * 
 * @return void * The stack top pointer.
 */
void *get_stack_top_ptr();

/**
 * @brief Returns a pointer pointing to the approximate bottom of the stack.
 * 
 * @return void * The stack bottom pointer.
 */
